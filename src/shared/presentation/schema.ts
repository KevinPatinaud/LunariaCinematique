...
export const ANIMATION_SCHEMA=obj({id,name:str(160,1),kind:en('frames','procedural','combined'),frames:array(frame,512),duration:num(.01,120),loop:bool,anchor:point,
 ...
 attachments:array(obj({id:attachment,x:num(-2,3),y:num(-2,3)}),4),markers:array(obj({id,at:num(0,120),type:en('release','sound','vfx'),ref:optionalId,attach:attachment}),64)});
